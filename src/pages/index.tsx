...
const IndexPage: React.FC<PageProps> = () => {
  return (
    <main>
      ...
      <div className="w-full relative flex justify-between pb-56 2md:pb-36 space-x-32 bg-gradient-to-r from-pink-100  to-pink-400">
        <div className="flex flex-col  space-y-3 z-10">
          ...
          <div className="font-mono -rotate-0 bg-clip-text text-transparent bg-gradient-to-r from-red-900 to-rose-400 mt-32  text-2xl  2xl:text-5xl   p-5">
            Look no further than our personalized invitation cards.
          </div>
        </div>
        <img loading="lazy" width={640} height={465} className="ml-auto hidden 2xl:block" src={CardImg} />
      ...
      <div className="w-full max-w-screen relative py-24 bg-white overflow-hidden">
        <div className="font-lobster text-3xl -rotate-0 bg-clip-text mb-10 text-transparent bg-gradient-to-r from-pink-500 to-black w-full text-center  p-5">
      ...
      <div className="w-full relative flex justify-between space-x-32 bg-gradient-to-r from-pink-100  to-pink-400">
        ...
        {/* <img className='absolute right-0 bottom-0 2xl:hidden aspect-[640/465] opacity-40' loading="lazy" src={CardImg} /> */}
      </div>
  ...
  return (
    <div className="overflow-x-auto mx-auto min-w-fit w-fit">
      <ul className="flex space-x-10 px-10 h-[500px] w-full">
        {
          list.map(({ cardImg, text }) => {
            return (
              <div className="min-w-fit h-fit flex flex-col space-y-1">
