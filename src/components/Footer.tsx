...
const Footer = () => {
  return (
    ...
    <footer className="from-pink-800 to-violet-900 bg-gradient-to-r text-center text-white">
      <div className="container px-6 pt-6 mx-auto">
        <SocialMediaIcons />
        <NewLetter />
        <div className="mb-6">
          <p>
            If you want to make your invitation for your occasion special, customized and thoughtful we are here!
            <br />
            Contact Us!
          </p>
        </div>
    ...
    <div>
      <form action="">
        <div
          ...
          <div className="relative md:mb-6 border rounded-md" data-te-input-wrapper-init>
            <input
              type="text"
